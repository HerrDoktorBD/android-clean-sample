[![Build Status](https://travis-ci.org/HerrDoktorBD/android-clean-sample-app.svg?branch=master)](https://travis-ci.org/HerrDoktorBD/android-clean-sample-app) [![Coverage Status](https://coveralls.io/repos/github/HerrDoktorBD/android-clean-sample-app/badge.svg?branch=master)](https://coveralls.io/github/HerrDoktorBD/android-clean-sample-app?branch=master)
